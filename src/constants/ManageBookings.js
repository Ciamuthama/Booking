  ...
  return (
    <View>
     <TouchableOpacity className='flex items-center space-y-2 mx-2 bg-orange-500 p-10' onPress={() => setOpen(true)}>
            <Text className='text-neutral-900 font-medium'>ManageBookings</Text>
            <Modal isVisible={open}>
              <View className='bg-white w-full h-1/4' style={{
                ...
                <TouchableOpacity className='flex items-center space-y-2 mx-2 bg-orange-500 p-4 rounded-lg' onPress={() => navigation.navigate('ManageBooking')}>
                  <Text className='text-neutral-900 font-medium'>ManageBookings</Text>
                </TouchableOpacity>
              </View>
            </Modal>
